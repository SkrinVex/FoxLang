...
* **Интеграция с Language Server (`foxlang-lsp`)**:
  ...
  * **Все ссылки (Find All References)**: `Shift+F12` — упоминания во всех файлах программы.
  * **Переименование (Rename Symbol)**: `F2` — объявление и все упоминания во всех файлах программы.
  * **Форматирование (Format Document)**: `Shift+Alt+F` — то же оформление, что `foxlang fmt`.
