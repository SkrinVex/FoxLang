...
((type_identifier) @type.builtin
  (#match? @type.builtin "^(int|string|bool|void|array|map|func|float|double|char)$"))

((identifier) @type.builtin
  (#match? @type.builtin "^func$"))
