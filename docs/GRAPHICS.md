...
Готовые кнопки, поля ввода с курсором и модальные окна, которые правильно
...
Встроенный шрифт 5×7 (у `g p q y j` — спуск ещё на две строки ниже, в пределах межстрочного интервала 9 пикселей) содержит латинский и русский алфавиты, цифры, знаки
