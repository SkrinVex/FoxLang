...
Глубина вложенных вызовов ограничена 2000. Рекурсия без условия выхода завершается
ошибкой `call depth limit`, а не аварийным падением процесса.
...
void api_home() {
    json_response("{\"message\":\"Welcome to FoxLang API!\",\"version\":\"5.6.1\"}");
}
