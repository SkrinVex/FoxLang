...
пиксельный шрифт и ввод с клавиатуры и мыши. Это API текущей ветки разработки,
добавленное после выпуска 5.6.0. Браузер и отдельный графический runtime не нужны.
