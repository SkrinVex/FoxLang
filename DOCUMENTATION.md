...
Вложенные массивы, словари и структуры принадлежат своему контейнеру: присваивание
копирует их целиком, так что копия никогда не делит данные с оригиналом.
...
* Копирование и передача — как у массивов: `map b = a;` копирует всё содержимое,
  функция получает сам словарь и может его менять, `==` сравнивает содержимое.
...
User older(User who) {
    ...
    return who;                 // вызывающий получает копию
}
...
* Копирование и передача — как у массивов: присваивание копирует структуру вместе
  с вложенными полями, функция получает её саму, `==` сравнивает поля.
