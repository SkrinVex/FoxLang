...
обычного). Сети, окон, звука и запуска процессов там нет — такие функции сообщают
об этом ошибкой; файлы живут в памяти до конца запуска, `input()` читает строки из
